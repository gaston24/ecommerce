...
?>
	...
	<div class="col-1 mt-5">
		<svg xmlns="http://www.w3.org/2000/svg" onclick="filterIncompletos()" width="20" height="20" fill="currentColor" class="bi bi-cart-x-fill" style="color: #dc3545; font-size: 20px;" viewBox="0 0 16 16" id="buttonIncompletos">
