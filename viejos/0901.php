...
$sql = "SELECT * FROM STA14 WHERE COD_PRO_CL IN ('GTCENT') AND EXPORTADO = 0 AND TCOMP_IN_S = 'RE'";
...
function insertar($remito){
	...
	FROM STA14 
	WHERE COD_PRO_CL IN ('GTCENT') AND N_COMP = '$remito'
	...
	UPDATE STA14 SET EXPORTADO = 1 WHERE COD_PRO_CL IN ('GTCENT') AND N_COMP = '$remito'
